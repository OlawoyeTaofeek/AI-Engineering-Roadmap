...
and quantization are the roof. The eight stages below are the spine tracked
in [`ROADMAP.md`](./ROADMAP.md) — `00`/`01` are prerequisite reading, and
`03`/`04`/`06`/`07`/`12` are the deep-dive modules that sit alongside a
stage rather than being one (see [Contents](#contents) for those).

<p align="center">
  <img src="./assets/roadmap.svg" alt="Repo roadmap — 8 stages, architecture through new trends" width="620">
</p>
